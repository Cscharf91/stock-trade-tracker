    ...
    <div className="form-wrapper">
      <form onSubmit={props.handleSubmit}>
        <div className="field">
          ...
          <input onChange={props.handleChange} type="text" value={props.trade.stock_symbol} name="stock_symbol" />
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <select onChange={props.handleChange} value={props.trade.market} name="market">
            <option value=""></option>
            <option value="with">Trading With</option>
            <option value="against">Trading Against</option>
          </select>
        </div>
        <div className="field">
          ...
          <select onChange={props.handleChange} value={props.trade.volume} name="volume">
            <option value=""></option>
            <option value="5">5x Volume</option>
            <option value="10">10x Volume</option>
          </select>
        </div>
        <div className="field">
        ...
        <div className="field">
          ...
          <select onChange={props.handleChange} value={props.trade.performance} name="performance">
            <option value=""></option>
            <option value="up-half">Half Win</option>
            <option value="up-full">Full Win</option>
            <option value="down-half">Half Loss</option>
            <option value="down-full">Full Loss</option>
          </select>
        </div>
        <div className="field">
